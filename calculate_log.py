...
def metric(dir_name, stypes = ['Ga3', 'gmm_Ga3'], verbose=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir_name', type=str, default='output/densenet_cifar10', help='Directory name')
    args = parser.parse_args()
    
    results = metric(args.dir_name, verbose=True)
    print(results)