...
def main():
    ...
    import pickle
    # with open('sample_mean_normal.pkl', 'wb') as f:
    #     pickle.dump(sample_mean, f)
    # with open('precision_normal.pkl', 'wb') as f:
    #     pickle.dump(precision, f)
    
    with open('sample_mean_normal.pkl', 'rb') as f:
        sample_mean = pickle.load(f)
    with open('precision_normal.pkl', 'rb') as f:
